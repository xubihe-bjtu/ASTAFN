...
parser.add_argument('--cpan_path', type=str, default='./dataset/California/pan_lat_lon.npy', help='Pangu Latitude and Longitude File')
parser.add_argument('--cera_path', type=str, default='./dataset/California/era_lat_lon.npy', help='ERA5 Latitude and Longitude File')
parser.add_argument('--csta_path', type=str, default='./dataset/California/obs_lat_lon.npy', help='Observation station Latitude and Longitude File')
parser.add_argument('--save_path', type=str, default='./save/California', help='Result Save File Path')
parser.add_argument('--data_path', type=str, default='./dataset/California', help='Input Data Path')
parser.add_argument('--adj_path', type=str, default='./dataset/California/sensor_graph/adj_mat.pkl', help='Observation Station Adjacency Matrix File Path')
...
parser.add_argument('--area',type=str,default='California',help='region')
parser.add_argument('--target', type=int, default=2, help='[u,v,msl,tmp]')
...
parser.add_argument('--num_nodes', type=int, default=101,help='Number of Observation Stations')
