...
parser.add_argument('--cpan_path', type=str, default='./dataset/YUNNAN/pan_lat_lon.npy', help='Pangu Latitude and Longitude File')
parser.add_argument('--cera_path', type=str, default='./dataset/YUNNAN/era_lat_lon.npy', help='ERA5 Latitude and Longitude File')
parser.add_argument('--csta_path', type=str, default='./dataset/YUNNAN/obs_lat_lon.npy', help='Observation station Latitude and Longitude File')
parser.add_argument('--save_path', type=str, default='./save/YUNNAN', help='Result Save File Path')
parser.add_argument('--data_path', type=str, default='./dataset/YUNNAN', help='Input Data Path')
parser.add_argument('--adj_path', type=str, default='./dataset/YUNNAN/sensor_graph/adj_mat.pkl', help='Observation Station Adjacency Matrix File Path')
...
parser.add_argument('--area',type=str,default='YUNNAN',help='region')
...
parser.add_argument('--model',type=str,default='HimNet',help='model type')
parser.add_argument('--lr', type=float, default=0.001, help='Training Learning Rate')
parser.add_argument('--weight_decay',type=float,default=0.0001,help='weight decay rate')
parser.add_argument('--num_nodes', type=int, default=21,help='Number of Observation Stations')
